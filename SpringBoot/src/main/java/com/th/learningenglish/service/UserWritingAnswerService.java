...
public class UserWritingAnswerService {
	...
	public List<UserWritingAnswers> findAll() {
		return repository.findAll();
	}

	public UserWritingAnswers findById(Long id) {
		return repository.findById(id).orElseThrow(() -> new RuntimeException("User writing answer not found"));
	}

	public UserWritingAnswers create(UserWritingAnswers item) {
	...
	public UserWritingAnswers update(Long id, UserWritingAnswers payload) {
		...
		c.setTaskScore(payload.getTaskScore());
